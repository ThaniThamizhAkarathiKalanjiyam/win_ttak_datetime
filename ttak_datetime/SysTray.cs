...
namespace ttak_datetime
{
        ...
        public class SysTray : IDisposable
        {
			...
			public SysTray(string text, Icon icon, ContextMenu menu)
            {
                ...
                m_font = new Font("Times New Roman", 10);
            ...
            public void setDoubleClickEvent(EventHandler DoubleClick)
            {
            m_notifyIcon.DoubleClick += DoubleClick;
            }
            ...
            public void ShowText(string text, Font font, Color col)
            {
                ...
                //Bitmap bitmap = new Bitmap(30, 16);
                ...
                Font fontToUse = new Font("Tahoma", 32, FontStyle.Regular, GraphicsUnit.Pixel);
                ...
                g.DrawString(text, fontToUse, brushToUse, -2, 0);
                hIcon = (bitmapText.GetHicon());
                m_notifyIcon.Icon = System.Drawing.Icon.FromHandle(hIcon);
